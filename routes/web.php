...
// Notification Routes
Route::prefix('admin/notification')->name('admin.notification.')->middleware(['auth', 'verified', 'role:super_admin'])->group(function () {
...
Route::prefix('admin/support')->name('admin.support.')->middleware(['auth', 'verified', 'role:super_admin'])->group(function () {
