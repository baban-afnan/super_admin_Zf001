<x-app-layout>
    ...
    <div class="page-body">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h4 class="mb-0 fw-bold text-dark">NIN IPE Dashboard</h4>
                <p class="text-muted small mb-0">Manage NIN IPE service requests.</p>
            </div>
            <div class="d-flex gap-3">
                <form action="{{ route('ninipe.checkBulkStatus') }}" method="POST" class="checkStatusForm">
                    @csrf
                    <button type="submit" class="btn btn-outline-primary d-flex align-items-center btnCheckStatus shadow-sm" style="border-radius: 10px; font-weight: 600;">
