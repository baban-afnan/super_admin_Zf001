...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">NIN IPE Request</h6>
            ...
            <div class="col-md-6 text-md-end">
                <div class="btn-group">
                    ...
                    @if(request('status') || request('search') || request('bank'))
                        <a href="{{ route('ninipe.index') }}" class="btn btn-outline-danger">
                ...
                <tbody>
                    ...
                    @forelse ($enrollments as $enrollment)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('ninipe.show', $enrollment->id) }}" class="btn btn-sm btn-primary">
