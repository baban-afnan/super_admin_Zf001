<x-app-layout>
      <title>Arewa Smart - Affidavit</title>
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            <h4 class="mb-0 fw-bold text-primary">Affidavit Details</h4>
                            <p class="text-muted mb-0">View and manage affidavit request</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('affidavit.index') }}" class="btn btn-light">
                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-header bg-white py-3 border-bottom">
                        <h5 class="card-title mb-0 fw-bold">
                            <i class="ti ti-info-circle me-2 text-primary"></i>Affidavit Information
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <label class="form-label text-muted small text-uppercase fw-bold">Additional Details</label>
                                <div class="p-3 bg-light rounded border">
                                    @php
                                        $newInfo = json_decode($enrollmentInfo->field, true);
                                    @endphp
                            ...
                            {{-- Documents Section --}}
                            <div class="col-12">
                                <label class="form-label text-muted small text-uppercase fw-bold mb-3">Uploaded Documents</label>
                                <div class="d-flex gap-3 flex-wrap">
                                    {{-- Primary File --}}
                                    @if($enrollmentInfo->file_url)
                                    <div class="card border p-3" style="min-width: 200px; max-width: 250px;">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ti ti-file-check fs-3 text-success me-2"></i>
                                            <span class="fw-bold">Affidavit File</span>
                                        </div>
                                        <div class="text-muted small mb-2">Main Document</div>
                                    ...
                                    <div class="card border p-3" style="min-width: 200px; max-width: 250px;">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ti ti-user-check fs-3 text-info me-2"></i>
                                            <span class="fw-bold">Passport Photo</span>
                                        </div>
                                        <div class="text-muted small mb-2">Passport Document</div>
                                        <a href="{{ Storage::url($enrollmentInfo->passport_url) }}" target="_blank" class="btn btn-sm btn-outline-info w-100">
                                            <i class="ti ti-download me-1"></i> Download
                                        </a>
                                    </div>
                                    @endif
                                    ...
                                    {{-- NIN Slip / ID Card --}}
                                    @if($enrollmentInfo->nin_slip_url)
                                    <div class="card border p-3" style="min-width: 200px; max-width: 250px;">
                                        <div class="d-flex align-items-center mb-2">
                                            <i class="ti ti-id fs-3 text-primary me-2"></i>
                                            <span class="fw-bold">ID Card</span>
                                        </div>
                                        <div class="text-muted small mb-2">Identity Document</div>
                                        <a href="{{ Storage::url($enrollmentInfo->nin_slip_url) }}" target="_blank" class="btn btn-sm btn-outline-primary w-100">
                                            <i class="ti ti-download me-1"></i> Download
                                        </a>
                                    </div>
                                    @endif

                                    @if(!$enrollmentInfo->file_url && !$enrollmentInfo->passport_url && !$enrollmentInfo->nin_slip_url)
    ...
    <div class="modal fade" id="updateStatusModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <form method="POST" action="{{ route('affidavit.update', $enrollmentInfo->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
