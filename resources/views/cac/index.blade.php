<x-app-layout>
    ...
    <div class="row g-3 mb-4">
        <div class="col-12">
            <h4 class="mb-0 fw-bold text-dark">CAC Registration Dashboard</h4>
            <p class="text-muted small">Manage and track CAC registration requests with ease.</p>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                <div class="card-body p-4 bg-white">
                    <form method="GET" action="{{ route('cac-registration.index') }}">
                            ...
                            <div class="col-lg-3">
                                <div class="d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search'))
                                        <a href="{{ route('cac-registration.index') }}" class="btn btn-outline-danger px-4 py-2 d-flex align-items-center justify-content-center">
                    ...
                    <tbody>
                        @forelse ($enrollments as $enrollment)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <span class="fw-bold text-dark">{{ $enrollment->company_type }}</span>
                                ...
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="text-dark fw-medium small">{{ $enrollment->field_name ?? 'No Bank' }}</span>
                                ...
                                <td class="pe-4 text-end">
                                    <a href="{{ route('cac-registration.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                            ...
                            <tr>
                                <td colspan="7" class="text-center py-5">
                                    <div class="py-4">
                                        ...
                                        <h6 class="text-muted fw-normal">No registration records found.</h6>
                                        @if(request('search') || request('status'))
                                            <a href="{{ route('cac-registration.index') }}" class="btn btn-link btn-sm mt-2">Clear all filters</a>
                                        @endif
                                    </div>
                                </td>
                            </tr>
