                ...
                <div class="col-md-8">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent p-0">
                            ...
                            <li class="breadcrumb-item active text-muted" aria-current="page">Edit: {{ $user->first_name }} {{ $user->last_name }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <form action="{{ route('admin.users.update', $user) }}" method="POST" id="editUserForm">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="number" step="0.01" name="limit" class="form-control" value="{{ old('limit', $user->limit) }}">
                                    @error('limit') <div class="text-danger small mt-1">{{ $message }}</div> @enderror
                                </div>
                            </div>

                            <div class="d-flex justify-content-end mt-5 pt-3 border-top">
                                <a href="{{ route('admin.users.index') }}" class="btn btn-light px-4 me-2 rounded-pill fw-bold">Cancel</a>
