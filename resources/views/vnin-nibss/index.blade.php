<x-app-layout>
    <title>Arewa Smart - VNIN to NIBSS</title>
    <div class="page-body">
        {{-- Header Section --}}
        <div class="row g-3 mb-4">
            <div class="col-12">
                <h4 class="mb-0 fw-bold text-dark">VNIN to NIBSS Dashboard</h4>
                <p class="text-muted small">Monitor and manage VNIN to NIBSS linking requests.</p>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                    <div class="card-body p-4 bg-white">
                        <form method="GET" action="{{ route('vnin-nibss.index') }}">
                            <div class="row g-3 align-items-center">
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search" class="form-control border-start-0 bg-light py-2" 
                                               placeholder="Search BVN, NIN, Ref, Agent..." value="{{ request('search') }}">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="input-group">
                                ...
                                <div class="col-lg-4 d-flex gap-2">
                                    ...
                                    @if(request('status') || request('search'))
                                        <a href="{{ route('vnin-nibss.index') }}" class="btn btn-outline-danger px-4 py-2"><i class="ti ti-refresh"></i></a>
                                    @endif
                                </div>
                            </div>
                        </form>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 1.25rem;">
            <div class="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold text-dark d-flex align-items-center">
                    <i class="ti ti-link me-2 text-primary fs-22"></i>
                    VNIN Linking Requests
                </h5>
                            ...
                            @forelse ($enrollments as $enrollment)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            <div class="d-flex align-items-center mb-1">
                                                <div class="avatar avatar-sm bg-primary-subtle text-primary rounded-circle me-2"><i class="ti ti-id fs-12"></i></div>
                                                <span class="fw-medium text-dark">{{ $enrollment->bvn }}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="pe-4 text-end">
                                        <a href="{{ route('vnin-nibss.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            <h6 class="text-muted fw-normal">No linking requests found.</h6>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
