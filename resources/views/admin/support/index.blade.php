    ...
    <div class="row g-3 mb-4">
        <div class="col-xl-3 col-md-6 fade-in-up" style="animation-delay: 0.1s;">
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--primary-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        <p class="stats-label mb-1" style="color: white;">Total Support</p>
                        <h3 class="stats-value mb-0">{{ $totalTickets }}</h3>
                        <small class="text-white-50 fs-12 fw-medium">All Time Requests</small>
                    </div>
        ...
        <div class="col-xl-3 col-md-6 fade-in-up" style="animation-delay: 0.2s;">
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--info-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        <p class="stats-label mb-1" style="color: white;">Monthly Received</p>
                        <h3 class="stats-value mb-0">{{ $monthlyReceived }}</h3>
                        <small class="text-white-50 fs-12 fw-medium">New This Month</small>
                    </div>
                    <div class="avatar avatar-lg bg-white bg-opacity-25 rounded-3">
                        <i class="ti ti-inbox fs-24 text-white"></i>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6 fade-in-up" style="animation-delay: 0.3s;">
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--warning-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        <p class="stats-label mb-1" style="color: white;">Monthly Open</p>
                        <h3 class="stats-value mb-0">{{ $customer_reply }}</h3>
                        <small class="text-white-50 fs-12 fw-medium">Unresolved from Month</small>
                    </div>
                    <div class="avatar avatar-lg bg-white bg-opacity-25 rounded-3">
        ...
        <div class="col-xl-3 col-md-6 fade-in-up" style="animation-delay: 0.4s;">
            <div class="financial-card shadow-sm h-100 p-4" style="background: var(--success-gradient);">
                <div class="d-flex justify-content-between align-items-start position-relative z-1">
                    <div>
                        <p class="stats-label mb-1" style="color: white;">Monthly Closed</p>
                        <h3 class="stats-value mb-0">{{ $monthlyClosed }}</h3>
                        <small class="text-white-50 fs-12 fw-medium">Resolved from Month</small>
                    </div>
                    <div class="avatar avatar-lg bg-white bg-opacity-25 rounded-3">
