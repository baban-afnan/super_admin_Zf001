<x-app-layout>
    <title>Arewa Smart- Data Services Management</title>
            ...
            <div class="col-xl-3 col-md-6 fade-in-up" style="animation-delay: 0.1s;">
                <div class="financial-card shadow-sm h-100 p-4 hover-lift" style="background: var(--indigo-gradient);">
                    <div class="d-flex justify-content-between align-items-start position-relative z-1">
                        <div>
                            <p class="stats-label mb-1" style="color: white;">Service Groups</p>
                            <h3 class="stats-value mb-0 text-white">{{ count($availableServices) }}</h3>
                        </div>
