<x-app-layout>
    ...
    <div class="page-body">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h4 class="mb-0 fw-bold text-dark">NIN Validation Dashboard</h4>
                <p class="text-muted small mb-0">Manage and track NIN validation requests.</p>
            </div>
            <div class="d-flex gap-2">
                <form action="{{ route('validation.checkS8vStatus') }}" method="POST" class="checkStatusForm">
                    @csrf
                    <button type="submit" class="btn btn-outline-success d-flex align-items-center btnCheckStatus shadow-sm" style="border-radius: 10px; font-weight: 600;">
    ...
    <script>
        document.querySelectorAll('.checkStatusForm').forEach(form => {
            form.addEventListener('submit', function() {
                ...
                text.innerText = 'Queuing...';
                
                if (typeof Swal !== 'undefined') {
                    Swal.fire({
                        title: 'Queuing Requests',
                        html: 'Please wait while we queue the status checks for processing...',
