<x-app-layout>
    ...
    <div class="page-body">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12">
                <h4 class="mb-0 fw-bold text-dark">CRM Service Dashboard</h4>
                <p class="text-muted small">Monitor and manage CRM service requests with precision.</p>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm overflow-hidden" style="border-radius: 1.25rem;">
                    <div class="card-body p-4 bg-white">
                        <form method="GET" action="{{ route('crm.index') }}">
                                ...
                                <div class="col-lg-6">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="search" class="form-control border-start-0 bg-light py-2" 
                                               placeholder="Search Ticket ID, Batch ID, Agent..." value="{{ request('search') }}">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="input-group">
                                ...
                                <div class="col-lg-4 d-flex gap-2">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end border-0 shadow-sm mt-1">
                                            <li><a class="dropdown-item py-2" href="{{ route('crm.export.csv') }}"><i class="ti ti-file-type-csv me-2 text-primary"></i>Export CSV</a></li>
                                            <li><a class="dropdown-item py-2" href="{{ route('crm.export.excel') }}"><i class="ti ti-file-spreadsheet me-2 text-success"></i>Export Excel</a></li>
                                        </ul>
                                    </div>
                                    @if(request('status') || request('search'))
                                        <a href="{{ route('crm.index') }}" class="btn btn-outline-danger px-4 py-2"><i class="ti ti-refresh"></i></a>
                                    @endif
                                </div>
                            </div>
                        </form>
        ...
        <div class="card border-0 shadow-sm" style="border-radius: 1.25rem;">
            <div class="card-header bg-white py-4 border-bottom-0 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold text-dark d-flex align-items-center">
                    <i class="ti ti-headset me-2 text-primary fs-22"></i>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        <thead class="bg-light text-muted small text-uppercase fw-bold">
                            <tr>
                                ...
                                <th class="py-3">Agent Name</th>
                                <th class="py-3">Ticket ID</th>
                                <th class="py-3">Batch Details</th>
                        ...
                        <tbody>
                            @forelse ($enrollments as $enrollment)
                                <tr>
                                    ...
                                    <td><span class="fw-bold text-dark">{{ $enrollment->performed_by }}</span></td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="avatar avatar-sm bg-primary-subtle text-primary rounded-circle me-2"><i class="ti ti-id fs-14"></i></div>
                                            <span class="fw-medium text-dark">{{ $enrollment->bank ?? $enrollment->ticket_id }}</span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex flex-column">
                                            <span class="text-dark fw-medium small">{{ $enrollment->service_field_name ?? $enrollment->batch_id }}</span>
                                            <small class="text-muted">Batch Reference</small>
                                        </div>
                                    </td>
                                    ...
                                    <td class="pe-4 text-end">
                                        <a href="{{ route('crm.show', $enrollment->id) }}" class="btn btn-icon btn-light btn-sm rounded-circle shadow-sm" data-bs-toggle="tooltip" title="View Details">
                                ...
                                <tr>
                                    <td colspan="7" class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            <h6 class="text-muted fw-normal">No CRM requests found.</h6>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
