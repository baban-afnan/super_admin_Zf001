                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">View and manage CRM service request</p>
                        </div>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row g-4">
                            ...
                            {{-- Ticket ID --}}
                            <div class="col-md-6">
                                <label class="form-label text-muted small text-uppercase fw-bold">Ticket ID</label>
                                <p class="fw-medium mb-0">{{ $enrollmentInfo->ticket_id }}</p>
                            </div>

                            {{-- Bactch id --}}
                            <div class="col-md-6">
                                <label class="form-label text-muted small text-uppercase fw-bold">Batch ID</label>
                                <p class="fw-medium mb-0">{{ $enrollmentInfo->batch_id }}</p>
                            </div>
