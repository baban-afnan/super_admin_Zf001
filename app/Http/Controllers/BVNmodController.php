...
class BVNmodController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('bvn.bvnmod', compact('enrollments', 'search', 'statusFilter', 'bankFilter', 'statusCounts', 'banks'));
    }

    /**
     * Show details of a single bvn_modification
     */
    public function show($id)
    {
        ...
        return view('bvn.bvnmod-view', compact('enrollmentInfo', 'statusHistory', 'user'));
    }

    /**
     * Update the status of a bvn_modification
     */
    ...
    private function sendStatusUpdateEmail($user, $enrollment, $fileUrl = null)
    {
        ...
        $serviceName = $service ? $service->name : 'BVN Service';
