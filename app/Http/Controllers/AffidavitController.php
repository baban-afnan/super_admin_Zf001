...
{
    /**
     * List affidavits with filters and pagination
     */
    public function index(Request $request)
    {
        ...
        $query = AgentService::query()
            ...
            ->where('agent_services.service_type', 'like', '%affidavit%');
        ...
        $baseCountQuery = AgentService::where('service_type', 'like', '%affidavit%');
        ...
        return view('affidavit.index', compact('enrollments', 'search', 'statusFilter', 'statusCounts'));
    }

    /**
     * Show details of a single affidavit
     */
    public function show($id)
    {
        ...
        return view('affidavit.view', compact('enrollmentInfo', 'statusHistory', 'user'));
    }

    /**
     * Update the status of an affidavit
     */
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            if ($request->hasFile('file')) {
                ...
                $filePath = $file->storeAs('affidavit-files', $fileName, 'public');
                $baseUrl = rtrim(config('app.url'), '/');
                $fileUrl = $baseUrl . '/storage/affidavit-files/' . $fileName;
            }
            ...
            DB::commit();
            return redirect()->route('affidavit.index')
    ...
    private function sendStatusUpdateEmail($user, $enrollment, $fileUrl = null)
    {
        ...
        $serviceName = $service ? $service->name : 'Affidavit Service';
        ...
        Mail::send('emails.affidavit-status-update', $data, function($message) use ($user, $serviceName) {
